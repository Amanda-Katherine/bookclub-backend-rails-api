...
Book.create(title: "Into the Wild", author: "Jon Krakauer", image: "http://books.google.com/books/content?id=waBwNtI6rSwC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api", description: "INTO THE WILD is based on a true story and the bestselling book by Jon Krakauer. After graduating from Emory University in 1992, top student and athlete Christopher McCandless (Hirsch) abandons his possessions, gave his entire $24,000 savings account to charity and hitchhiked to Alaska to live in the wilderness. Along the way, Christopher encounters a series of characters that shape his life.")
...
Book.create(title: "The Great Gatsby", author: "F. Scott Fitzgerald", image: "https://images-na.ssl-images-amazon.com/images/I/41iers%2BHLSL._SL160_.jpg", description: "The novel chronicles an era that Fitzgerald himself dubbed the 'Jazz Age'. Following the shock and chaos of World War I, American society enjoyed unprecedented levels of prosperity during the 'roaring' 1920s as the economy soared. At the same time, Prohibition, the ban on the sale and manufacture of alcohol as mandated by the Eighteenth Amendment, made millionaires out of bootleggers and led to an increase in organized crime, for example the Jewish mafia. Although Fitzgerald, like Nick Carraway in his novel, idolized the riches and glamor of the age, he was uncomfortable with the unrestrained materialism and the lack of morality that went with it, a kind of decadence.")

BookGroup.create(name: "Member does not have a book club", password: "password", id: 0) #set default to zero so first 'real' group will have an id of 1
BookGroup.create(name: "The Bookworms", password: "password")
BookGroup.create(name: "The Wild Readers", password: "password")
BookGroup.create(name: "All Booked", password: "password")
BookGroup.create(name: "Booked Ends", password: "password")

Member.create(first_name: "Megan", last_name: "Rapinoe", email: "fake_email1@fake.com", password: "password", book_group_id: "2")
Member.create(first_name: "Sue", last_name: "Bird", email: "fake_email2@fake.com", password: "password", book_group_id: "2")
Member.create(first_name: "Larry", last_name: "Fitzgerald", email: "fake_email3@fake.com", password: "password", book_group_id: "1")
Member.create(first_name: "LeBron", last_name: "James", email: "fake_email14@fake.com", password: "password", book_group_id: "4")
Member.create(first_name: "Randy", last_name: "Johnson", email: "fake_email15@fake.com", password: "password", book_group_id: "1")
Member.create(first_name: "Jackie", last_name: "Robinson", email: "fake_email16@fake.com", password: "password", book_group_id: "4")
Member.create(first_name: "Babe", last_name: "Ruth", email: "fake_email17@fake.com", password: "password", book_group_id: "3")
Member.create(first_name: "Brett", last_name: "Favre", email: "fake_email18@fake.com", password: "password", book_group_id: "1")
Member.create(first_name: "Wes", last_name: "Welker", email: "fake_email19@fake.com", password: "password", book_group_id: "3")
Member.create(first_name: "Joe", last_name: "Montana", email: "fake_email10@fake.com", password: "password", book_group_id: "4")
